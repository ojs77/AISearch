...
def alg_b_basic(dist_matrix, max_iter, p, alpha, beta, w=0):
    ...
    class Ant:
        ...
        def route(self, alpha, beta, edge_matrix):
            ...
            ant.current_position = ant.starting_position
            ant.path = [ant.starting_position]
            ant.path_cost = 0
...
tour, tour_length = alg_b_basic(dist_matrix, 175, 0.1, 1, 5, 6)
